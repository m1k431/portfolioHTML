...
var monIntro = function monIntro() {
  ...
  BtnJs0nPl4Y.addEventListener('click', function () {
    if (m4vide0.paused) {
      m4vide0.play();
      BtnJs0nPl4Y.innerHTML = 'PAUSE';
    } else {
  ...
  BtnJs0nPl4Y.click();
  $('#jugglejungle').fadeIn(100); //Blue/red menu button
  ...
  m0nsoleil.id = 's0leil'; //360backnoreverse
  ...
  src360.type = 'video/webm'; //ATARIIIIIIIIII
  ...
  m0nsoleil.appendChild(m0nCanva); //Lune
  ...
  m0nsoleil.appendChild(maLune); //cloud img
  ...
  m0nsoleil.appendChild(imgCloud); //mer
  ...
  m0nsoleil.appendChild(m4m3r); //colline
  ...
  ctx2M4col.closePath();
  ctx2M4col.stroke();
  ctx2M4col.fill(); //C00000000000000000000000000000llllllllllllllllOLLLLIIIIIINNNNNNE 1
  ...
  ctxM4col.closePath();
  ctxM4col.stroke();
  ctxM4col.fill(); //SONIC PALM TREEEEEEEE
  ...
  imgSonic.src = '/static/img/sonic2.png'; //BIRD div
