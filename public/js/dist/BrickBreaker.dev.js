...
var jeuBreaker = function jeuBreaker() {
  ...
  }, 700); //_______________________________Choix_langue____________________________________________________________________________

  $('.english').fadeIn();
  $('#competen').fadeIn();

  window.document.getElementById('french').onclick = function () {
    //play(flagS)
    $('.english').hide();
    $('.spanish').hide();
    $('.french').hide(); //$('#competen').css('height', 'auto')

    $('.french').fadeIn();
  };

  window.document.getElementById('english').onclick = function () {
    //play(flagS)
    $('.french').hide();
    $('.spanish').hide();
    $('.english').hide();
  ...
  function varsStart() {
    ...
    competences.appendChild(divSprite); //________________________________________footBall Sprite_________________________________________________
    ...
    complementaire.className = 'complementaireT'; //________________________________________INITIALISTATION BRICKS_______________________________________
    ...
    $('#informatique').animate({
      width: '98%'
    }, 1000); //_________________________________________INITIALISATIION_JEU______________________________________
    ...
    var eTouchStart = function eTouchStart(e) {
    ...
    var movepaddle = function movepaddle(mon0bjetEvent) {
    ...
    var brickBroken = function brickBroken() {
      ...
      while (i >= 0) {
        ...
        if (ballX + divSprite.offsetWidth > mesInfosT[i].offsetLeft && ballX < mesInfosT[i].offsetLeft + mesInfosT[i].offsetWidth && ballY + divSprite.offsetHeight > mesInfosT[i].offsetTop && ballY < mesInfosT[i].offsetTop + mesInfosT[i].offsetHeight) {
          //left collision
          if (mesInfosT[i].offsetLeft - ballX - divSprite.offsetWidth > ballY - mesInfosT[i].offsetTop - mesInfosT[i].offsetHeight && mesInfosT[i].offsetLeft - ballX - divSprite.offsetWidth > mesInfosT[i].offsetTop - ballY - divSprite.offsetHeight) ballLeft = true; //right collision
          else if (ballX - mesInfosT[i].offsetLeft - mesInfosT[i].offsetWidth > ballY - mesInfosT[i].offsetTop - mesInfosT[i].offsetHeight && ballX - mesInfosT[i].offsetLeft - mesInfosT[i].offsetWidth > mesInfosT[i].offsetTop - ballY - divSprite.offsetHeight) ballLeft = false;else if (ballDown == false) ballDown = true;else ballDown = false;
          play(pongC);
          $(mesInfosT[i]).animate({
    ...
    var bouclePrincpale = function bouclePrincpale() {
      ...
      if (delta > interval) {
        ...
        if (!youwin || !clickMove) {
          ...
          if (stopEvent) {
            window.document.removeEventListener('click', animMoveBall, true); //cancelAnimationFrame(idAni)
            //cancelAnimationFrame(idL)
